$(function() {
    ...
    var musk_width = $(document.body).width();
    var musk_height = $(document.body).height();
...
// 监听滚动事件
// $('.newProducts').mouseenter(function() {
//     $('.newProducts').animate({ top: -100 }, 600, function() {
//         $('.new2').animate({ top: -130 }, 800);
//     });
// });
// $('.new3').mouseenter(function() {
//     $('.new3').animate({ top: -100 }, 500);
// });
// $('.hotProducts').mouseenter(function() {
//     $('.hotProducts').animate({ top: -210 }, 700);
// });
// $('.hot2-bottom').mouseenter(function() {
//     $('.hot2-bottom').animate({ top: -100 }, 500);
// });
...
$(window).scroll(function() {
    ...
    if ($(window).scrollTop() > 500) {
        $('.newProducts').animate({ top: -120 }, 600, function() {
            $('.new2').animate({ top: -130 }, 800);
        });
        $("#toTop").stop().fadeIn(200);
    } else if ($(window).scrollTop() > 1800) {
        $('.new3').animate({ top: -120 }, 500);
    }
